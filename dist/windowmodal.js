...
var windowmodal = (function () {
  ...
  */
  function Window(title, options) {
    ...
    var WindowUtil = {
      getProperty: function getProperty(options, opt, def) {
    ...
    var size_state = WindowState.NORMAL; // var selected = false;
    ...
    if (_typeof(options.position) !== "object") {
      options.position = {};
    }
    ...
    function resize_mouseDrag(e) {
      ...
      var delta_x = 0;
      var delta_y = 0;
      var min_size = WindowUtil.getProperty(options, "min_size", {
        width: 200,
        height: 150
      });
    ...
    this.changeState = function (_state) {
      ...
      self.on("change_state")({
        old_state: size_state,
        new_state: _state
      });
      size_state = _state;
    ...
    this.changeWindowState = function (_window_state) {
      ...
      self.on("change_window_state")({
        old_window_state: display_state,
        new_window_state: _window_state
      });
    ...
    function updateSize() {
      ...
      var _min_size = WindowUtil.getProperty(options, "min_size", {
        width: 200,
        height: 150
      });
    ...
    this.dispose = function () {
      if (self.on("disposing")() !== false) {
        document.head.removeChild(container.customStyle);
        container.customStyle = null;
        this.content.remove();
        this.content = null;
        container.remove();
        container = null;
    ...
    function styleModal(uniqueID) {
      ...
      var _ref = function () {
        ...
        return [style, style.sheet];
          ...
          style = _ref2[0],
          sheet = _ref2[1]; // Define css rules here


      var rules = [".".concat(uniqueID, "_window{\n  border: 1px solid #ccc;\n  position: absolute;\n  z-index: 1;\n  border-radius: 2px;\n  box-sizing: border-box;\n\n  transform: scale(1);\n}"), ".".concat(uniqueID, "_window:not(.window_no_animation):not(.window_moving){\n  transition: transform 0.2s, width 0.1s, height 0.1s, left 0.02s, right 0.02s;\n}"), ".".concat(uniqueID, "_window *{\n  position: relative;\n  box-sizing: border-box;\n}"), ".".concat(uniqueID, "_window.window_alway_on_top{\n  z-index: 10;\n}"), ".".concat(uniqueID, "_window.window_alway_on_top.window_selected{\n  z-index: 11;\n}"), ".".concat(uniqueID, "_window .window_bar{\n  border-bottom: 1px solid #ccc;\n  background-color: #eee;\n  height: 2em;\n}"), ".".concat(uniqueID, "_window .window_bar, .text_not_selectable{\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n  user-select: none;\n}"), ".".concat(uniqueID, "_window .window_bar > *{\n  display: inline-block;\n}"), ".".concat(uniqueID, "_window .window_bar *{\n  transition: all 0.2s;\n}"), ".".concat(uniqueID, "_window .window_bar .window_icon{\n  margin: 0 10px;\n  text-align: center;\n  vertical-align: middle;\n  cursor: pointer;\n}"), ".".concat(uniqueID, "_window .window_bar .window_title{\n  cursor: default;\n  padding: 5px;\n  overflow: hidden;\n  max-width: calc(100% - 150px);\n  vertical-align: middle;\n}"), ".".concat(uniqueID, "_window .window_bar .window_toggle_buttons{\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  right: 0;\n  vertical-align: top;\n  margin-left: 10px;\n  z-index: 2;\n}"), ".".concat(uniqueID, "_window .window_bar .window_toggle_buttons:after{\n  clear: both;\n}"), ".".concat(uniqueID, "_window .window_bar .window_toggle_buttons > *{\n  padding-top: 2px;\n  padding-bottom: 5px;\n  width: 2em;\n  text-align: center;\n  cursor: pointer;\n  height: 100%;\n  overflow: hidden;\n  display: inline-block;\n}"), ".".concat(uniqueID, "_window .window_bar .window_toggle_buttons > *:hover{\n  background-color: #ccc;\n}"), ".".concat(uniqueID, "_window.window_not_maximizable .window_button_toggle_maximize, .").concat(uniqueID, "_window.window_not_minimizable .window_button_minimize{\n  display: none;\n}"), ".".concat(uniqueID, "_window .window_bar .window_toggle_buttons .window_button_close:hover{\n  background-color: #ccc;\n}"), ".".concat(uniqueID, "_window .window_content{\n  overflow: auto;\n  background-color: #fff;\n  position: absolute;\n  top: 2em;\n  right: 0;\n  left: 0;\n  bottom: 0;\n}"), ".".concat(uniqueID, "_window.window_maximized:not(.window_minimized){\n  top: 0 !important;\n  left: 0 !important;\n  right: 0 !important;\n  bottom: 0 !important;\n\n  width: 100% !important;\n  height: 100% !important;\n}"), ".".concat(uniqueID, "_window.window_minimized{\n  transform: scale(0);\n}"), ".".concat(uniqueID, "_window.window_hidden{\n  display: none;\n}"), ".".concat(uniqueID, "_window.window_selected{\n  -webkit-box-shadow: 0px 0px 17px -4px rgba(0,0,0,0.73);\n  -moz-box-shadow: 0px 0px 17px -4px rgba(0,0,0,0.73);\n  box-shadow: 0px 0px 17px -4px rgba(0,0,0,0.73);\n  z-index: 2;\n}"), ".".concat(uniqueID, "_window.window_selected .window_bar{\n  background-color: #ddd;\n}"), ".".concat(uniqueID, "_window.window_selected .window_bar .window_toggle_buttons .window_button_close:hover{\n  background-color: #f12;\n  color: #fff;\n}"), ".".concat(uniqueID, "_window.window_maximized .window_resize_handle, .").concat(uniqueID, "_window.window_not_resizable .window_resize_handle, .").concat(uniqueID, "_window.window_resizing .window_resize_handle{\n  display: none;\n}"), ".".concat(uniqueID, "_window .window_resize_handle{\n  position: absolute;\n  display: block;\n  opacity: 0;\n}"), ".".concat(uniqueID, "_window .window_resize_handle_n, .window_resize_handle_s{\n  height: 3px;\n  left: 0;\n  right: 0;\n}"), ".".concat(uniqueID, "_window .window_resize_handle_w, .").concat(uniqueID, "_window .window_resize_handle_e{\n  width: 3px;\n  top: 0;\n  bottom: 0;\n}"), ".".concat(uniqueID, "_window .window_resize_handle_n, .").concat(uniqueID, "_window .window_resize_handle_ne, .").concat(uniqueID, "_window .window_resize_handle_nw{\n  top: -3px;\n}"), ".".concat(uniqueID, "_window .window_resize_handle_s, .").concat(uniqueID, "_window .window_resize_handle_se, .").concat(uniqueID, "_window .window_resize_handle_sw{\n  bottom: -3px;\n}"), ".".concat(uniqueID, "_window .window_resize_handle_w, .").concat(uniqueID, "_window .window_resize_handle_sw, .").concat(uniqueID, "_window .window_resize_handle_nw{\n  left: -3px;\n}"), ".".concat(uniqueID, "_window .window_resize_handle_e, .").concat(uniqueID, "_window .window_resize_handle_ne, .").concat(uniqueID, "_window .window_resize_handle_se{\n  right: -3px;\n}"), ".".concat(uniqueID, "_window .window_resize_handle_ne, .").concat(uniqueID, "_window .window_resize_handle_se, .").concat(uniqueID, "_window .window_resize_handle_sw, .").concat(uniqueID, "_window .window_resize_handle_nw{\n  width: 3px;\n  height: 3px;\n}"), ".".concat(uniqueID, "_window.window_bar_hidden .window_bar{\n  display: none;\n}"), ".".concat(uniqueID, "_window.window_bar_hidden .window_content{\n  top: 0;\n}")]; // Add rules to new stylesheet
